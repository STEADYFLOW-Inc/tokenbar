...
$src = @("Program.cs", "Config.cs", "Strings.cs", "UsageReader.cs", "ApiUsageReader.cs", "UsageCache.cs", "AppContext.cs", "WidgetForm.cs", "SettingsForm.cs", "SetupForm.cs", "MonitorPicker.cs", "CardRenderer.cs", "Theme.cs", "AssemblyInfo.cs")
$refs = @(
    "/r:System.dll",
    "/r:System.Core.dll",
